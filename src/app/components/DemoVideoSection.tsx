      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-[#22242B] shadow-md cursor-pointer aspect-video bg-[#0B0C0E]">
          ...
          {!playing && (
            ...
            >
              <div className="w-16 h-16 bg-[#14151A]/90 backdrop-blur-sm rounded-full flex items-center justify-center border border-[#22242B] shadow-md group-hover:scale-110 group-hover:bg-[#DC2626] group-hover:text-white transition-all">
          ...
          {playing && (
            <div className="absolute inset-0 flex items-center justify-center bg-[#0B0C0E] text-white">
              <div className="text-center">
                <Icon name="TvIcon" size={40} className="text-[#DC2626] mx-auto mb-3" />
