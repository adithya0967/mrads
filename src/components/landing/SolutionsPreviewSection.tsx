  ...
  return (
    <section id="solutions" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 lg:py-20">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-10" id="solutionGrid">
        <a href="#display" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in block">
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Display Advertising</h3>
        ...
        <a href="#moving" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in reveal-d1 block">
          <div className="h-44 overflow-hidden img-zoom relative">
            <img
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Advertising on the Move</h3>
            <p className="text-slate-400 text-[13.5px] mt-2">
        ...
        <a href="#offline" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in reveal-d2 block">
          <div className="h-44 overflow-hidden img-zoom relative">
            <img
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Offline Distribution</h3>
            <p className="text-slate-400 text-[13.5px] mt-2">
        ...
        <a href="#creative" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in block">
          <div className="h-44 overflow-hidden img-zoom relative">
            <img
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Print & Creative Design</h3>
            <p className="text-slate-400 text-[13.5px] mt-2">
        ...
        <a href="#offline" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in reveal-d1 block">
          <div className="h-44 overflow-hidden img-zoom relative">
            <img
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Newspaper & Quick Commerce Inserts</h3>
            <p className="text-slate-400 text-[13.5px] mt-2">
        ...
        <a href="#offline" className="group bg-[#121B2D] border border-slate-800 rounded-3xl overflow-hidden shadow-card card-hover reveal in reveal-d2 block">
          ...
          <div className="p-6">
            <h3 className="font-extrabold text-[17px] text-white group-hover:text-brand transition">Pharmacy Cover Advertising</h3>
            <p className="text-slate-400 text-[13.5px] mt-2">
        ...
        <a href="#digital" className="group lg:col-span-3 bg-[#162238] border border-slate-700 text-white rounded-3xl overflow-hidden shadow-lift card-hover reveal in block">
          <div className="grid md:grid-cols-2">
            <div className="p-7 sm:p-10">
              <span className="bg-brand text-white text-[11px] font-bold px-3 py-1.5 rounded-full">
                G · Website, Development & AI
              </span>
              <h3 className="serif text-2xl sm:text-3xl mt-4 text-white">Your offline buzz, backed by a premium online home.</h3>
      ...
      <div className="mt-10 bg-brand rounded-[28px] p-8 sm:p-12 text-white relative overflow-hidden shadow-lift reveal in">
        ...
        <div className="relative grid lg:grid-cols-3 gap-6 items-center">
          <div className="lg:col-span-2">
            <h3 className="serif text-3xl sm:text-[38px] leading-tight text-white">Make Your Brand Visible Where Your Audience Is.</h3>
