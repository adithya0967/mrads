    ...
    <section className="relative border-b border-line bg-[#080808] overflow-hidden">
      ...
      <div className="container-site py-20 md:py-28 relative z-10">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-white/[0.07] bg-white/[0.015] p-7 sm:p-9 flex flex-col justify-between">
            <div>
              ...
              <ul className="mt-6 space-y-6">
                {problems.map((item) => (
                  <li key={item.title} className="flex items-start gap-4">
                    <span className="flex items-center justify-center w-6 h-6 rounded-full bg-white/[0.04] border border-white/10 text-[#666666] shrink-0 mt-0.5">
                      <X size={13} strokeWidth={2.5} />
                    </span>
                    <div>
                      <h3 className="text-[15px] font-medium text-[#B8B4AE]">
                        {item.title}
                      </h3>
          ...
          {/* Column 2: The Mr. Ads Approach */}
          <div className="relative rounded-2xl border border-[#D81F42]/30 bg-gradient-to-b from-[#141414] to-[#0A0A0A] p-7 sm:p-9 shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_30px_rgba(216,31,66,0.1)] flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-white/[0.08]">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D81F42]/15 text-[11px] text-[#ED3153] font-bold border border-[#D81F42]/30">
                  Proven Impact
                </span>
              </div>
              ...
              <ul className="mt-6 space-y-6">
                {approach.map((item) => (
                  <li key={item.title} className="flex items-start gap-4">
                    <span className="flex items-center justify-center w-6 h-6 rounded-full bg-[#D81F42]/20 border border-[#D81F42]/40 text-[#ED3153] shrink-0 mt-0.5">
